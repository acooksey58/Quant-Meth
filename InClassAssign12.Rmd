...
## Question 1
 ...
 We begin by analyzing the data contained in the
  ...
  discussion.
```{r}
filedrawer <- read.csv("filedrawer.csv")
...
We next examine if there exists any difference in the
  ...
  findings.
```{r}
filedrawer$published <- ifelse(filedrawer$DV == "Published, top" | filedrawer$DV == "Published, non top", 1, 0)

pub.strong <- sum(filedrawer$pub.2[filedrawer$IV == "Strong"])
pub1.strong <- length(filedrawer$pub.2[filedrawer$IV == "Strong"])

pub.weak <- sum(filedrawer$pub.2[filedrawer$IV == "Weak"])
pub1.weak <- length(filedrawer$pub.2[filedrawer$IV == "Weak"])

pub.null <- sum(filedrawer$pub.2[filedrawer$IV == "Null"])
pub1.null <- length(filedrawer$pub.2[filedrawer$IV == "Null"])

prop.test(c(pub.strong, pub.null), c(pub1.strong, pub1.null))
prop.test(c(pub.strong, pub.weak), c(pub1.strong, pub1.weak))
```
